    ...
    <nav class="navbar navbar-expand-md navbar-light">
      <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="about.php">weight and health</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="history.php">BMI history</a>
          </li>
          
          <li class="nav-item">
            <!-- Login/Sign Up button -->
            <button class="btn btn-signup"><a href="login.php">logout </a></button>
